...
<p class="fl_right"><?php _e('Banner dimensions: 870px with variable height','protean')?></p>

<table class="protean_form_table" cellspacing="2" cellpadding="5" id="protean_banner_options">
	<tbody>
		<tr class="form-field">
			<th valign="middle" scope="row"><label for="link_notes"><strong><?php _e('Banner:','protean')?></strong></label></th>
			<td>
				...
				<button type="button" class="pretean_open_filemanager button-secondary fl_left" style="width: 90px;" rel="protean_banner_bgimage"><?php _e('Choose image','protean')?></button> 
				...
				<span class="protean_text_in_form"><a href="#" id="protean_clear_bannerbgimage"><?php _e('Clear Background Image','protean')?></a></span>
			</td>
		</tr>
		<tr class="form-field">
			<th valign="middle" scope="row"><label for="link_notes"><strong><?php _e('Border:','protean')?></strong></label></th>
			<td>
		...
		<tr class="form-field">
			<th valign="middle" scope="row"><label for="link_image"><strong><?php _e('Title:','protean')?></label></th>
			<td>
				<select name="<?php echo $paramname; ?>[bannertitle_font]" id="protean_bannertitle_font" class="fl_left" style="width:150px;">
					<option value=""><?php _e('Same as page style','protean')?></option>
				...
				<select name="<?php echo $paramname; ?>[bannertitle_fontsize]" id="protean_bannertitle_fontsize"  class="fl_left">
					<option value="16"><?php _e('Default','protean')?></option>
				...
				<select name="<?php echo $paramname; ?>[bannertitle_lineheight]" id="protean_bannertitle_lineheight" class="fl_left">
					<option value="1.5"><?php _e('Default','protean')?></option>
				...
				<select name="<?php echo $paramname; ?>[bannertitle_shadow]" id="protean_bannertitle_shadow" class="fl_left">
					<option value=""><?php _e('None','protean')?></option>
		...
		<tr class="form-field">
			<th valign="middle" scope="row"><label for="link_image"><strong><?php _e('Subtitle:','protean')?></label></th>
			<td>
				...
				<select name="<?php echo $paramname; ?>[bannersubtitle_fontsize]" id="protean_bannersubtitle_fontsize"  class="fl_left">
					<option value="14"><?php _e('Default','protean')?></option>
		...
		<tr>
			<td></td>
			<td><small><?php _e('To edit subtitle, please see post Excerpt.','protean')?></small></td>
		</tr>
	</tbody>
</table>